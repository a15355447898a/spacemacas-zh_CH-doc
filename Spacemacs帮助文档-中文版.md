...
## 目录
1. [Spacemacs帮助文档-中文版](#spacemacs帮助文档-中文版)
   1. [目录](#目录)
   2. [Quick start](#quick-start)
      1. [1 Configuration layers](#1-configuration-layers)
      2. [2 Dotfile (.spacemacs)](#2-dotfile-spacemacs)
      3. [3 Dotdirectory (~/.spacemacs.d)](#3-dotdirectory-spacemacsd)
      4. [4 Learning Spacemacs](#4-learning-spacemacs)
         1. [4.1 Editing Styles](#41-editing-styles)
         2. [4.2 The leader keys](#42-the-leader-keys)
         3. [4.3 Evil-tutor](#43-evil-tutor)
         4. [4.4 Universal argument](#44-universal-argument)
         5. [4.5 Configuration layers and Package discovery](#45-configuration-layers-and-package-discovery)
         6. [4.6 Key bindings discovery](#46-key-bindings-discovery)
         7. [4.7 Describe functions](#47-describe-functions)
      5. [5 How-To's](#5-how-tos)
   3. [Core Pillars](#core-pillars)
      1. [1.1 Mnemonic](#11-mnemonic)
      2. [1.2 Discoverable](#12-discoverable)
      3. [1.3 Consistent](#13-consistent)
      4. [1.4 Crowd-configured](#14-crowd-configured)
      5. [2 Highlighted feature](#2-highlighted-feature)
      6. [3 Screenshots](#3-screenshots)
      7. [4 Who can benefit from this?](#4-who-can-benefit-from-this)
      8. [5 Update and Rollback](#5-update-and-rollback)
         1. [5.1 Update Spacemacs repository](#51-update-spacemacs-repository)
            1. [5.1.1 Automatic Updates](#511-automatic-updates)
            2. [5.1.2 Updating from the Spacemacs Buffer](#512-updating-from-the-spacemacs-buffer)
            3. [5.1.3 Updating Manually with git](#513-updating-manually-with-git)
      9. [5.2 Update packages](#52-update-packages)
   4. [6 Configuration layers](#6-configuration-layers)
      1. [6.1 Purpose](#61-purpose)
      2. [6.2 Structure](#62-structure)
      3. [6.3 Configure packages](#63-configure-packages)
         1. [With a layer](#with-a-layer)
            1. [6.3.1.1Declaration](#6311declaration)
            2. [6.3.1.2 Initialization](#6312-initialization)
            3. [6.3.1.3 Exclusion](#6313-exclusion)
         2. [6.3.2 Without a layer](#632-without-a-layer)
      4. [6.4 Packages synchronization](#64-packages-synchronization)
      5. [6.5 Types of configuration layers](#65-types-of-configuration-layers)
      6. [6.6 Submitting a configuration layer upstream](#66-submitting-a-configuration-layer-upstream)
      7. [6.7 Example: Themes Megapack example](#67-example-themes-megapack-example)
      8. [6.8 Managing private configuration layers](#68-managing-private-configuration-layers)
         1. [6.8.1 Using the private directory](#681-using-the-private-directory)
         2. [6.8.2 Using an external Git repository](#682-using-an-external-git-repository)
         3. [6.8.3 Using a personal branch](#683-using-a-personal-branch)
      9. [6.9 Tips for writing layers](#69-tips-for-writing-layers)
   5. [7 Dotfile Configuration](#7-dotfile-configuration)
      1. [7.1 Dotfile Installation](#71-dotfile-installation)
      2. [7.2 Alternative dotdirectory](#72-alternative-dotdirectory)
      3. [7.3 Synchronization of dotfile changes](#73-synchronization-of-dotfile-changes)
      4. [7.4 Testing the dotfile](#74-testing-the-dotfile)
      5. [7.5 Dotfile Contents](#75-dotfile-contents)
         1. [7.5.1 Configuration functions](#751-configuration-functions)
         2. [7.5.2自定义变量](#752自定义变量)
      6. [7.6 Declaring Configuration layers](#76-declaring-configuration-layers)
         1. [7.6.1 Setting configuration layers variables](#761-setting-configuration-layers-variables)
         2. [7.6.2 Disabling layer services in other layers](#762-disabling-layer-services-in-other-layers)
         3. [7.6.3 Selecting/Ignoring packages of a layer](#763-selectingignoring-packages-of-a-layer)
         4. [7.6.4 Excluding packages](#764-excluding-packages)
   6. [8 Concepts](#8-concepts)
      1. [8.1 Editing Styles](#81-editing-styles)
         1. [8.1.1Vim](#811vim)
         2. [8.1.2 Emacas](#812-emacas)
         3. [8.1.3 Hybrid](#813-hybrid)
      2. [8.2 States](#82-states)
      3. [8.3 Evilified modes](#83-evilified-modes)
      4. [8.4 Evil leader](#84-evil-leader)
      5. [8.5 Universal argument](#85-universal-argument)
      6. [8.6 Transient-states](#86-transient-states)
   7. [9 Differences between Vim, Evil and Spacemacs](#9-differences-between-vim-evil-and-spacemacs)
      1. [9.1 The vim-surround case](#91-the-vim-surround-case)
   8. [10 Evil plugins](#10-evil-plugins)
   9. [11 Binding keys](#11-binding-keys)
   10. [12 GUI Elements](#12-gui-elements)
      1. [12.1 Color themes](#121-color-themes)
      2. [12.2 Font](#122-font)
      3. [12.3 GUI Toggles](#123-gui-toggles)
         1. [12.3.1 Global line numbers](#1231-global-line-numbers)
      4. [12.4 Mode-line](#124-mode-line)
         1. [12.4.1 Powerline font installation for terminal-mode users](#1241-powerline-font-installation-for-terminal-mode-users)
         2. [12.4.2 Flycheck integration](#1242-flycheck-integration)
         3. [12.4.3 Anzu integration](#1243-anzu-integration)
         4. [12.4.4 Battery status integration](#1244-battery-status-integration)
         5. [12.4.5 Powerline separators](#1245-powerline-separators)
         6. [12.4.6 Minor Modes](#1246-minor-modes)
         7. [12.4.7 Customizing the mode-line](#1247-customizing-the-mode-line)
   11. [13 Layouts](#13-layouts)
      1. [13.1 The default layout](#131-the-default-layout)
      2. [13.2 Project layouts](#132-project-layouts)
      3. [13.3 Custom Layouts](#133-custom-layouts)
      4. [13.4 Save/Load layouts into a file](#134-saveload-layouts-into-a-file)
      5. [13.5 Layout key bindings](#135-layout-key-bindings)
      6. [13.6 Workspaces](#136-workspaces)
      7. [13.7 Workspace key bindings](#137-workspace-key-bindings)
   12. [14 Commands](#14-commands)
      1. [14.1 Vim key bindings](#141-vim-key-bindings)
         1. [14.1.1 Escaping](#1411-escaping)
         2. [14.1.2 Executing Vim and Emacs ex/M-x commands](#1412-executing-vim-and-emacs-exm-x-commands)
         3. [14.1.3 Leader key](#1413-leader-key)
         4. [14.1.4 Additional text objects](#1414-additional-text-objects)
      2. [14.2为用户保留前缀命令](#142为用户保留前缀命令)
      3. [14.3 Completion](#143-completion)
         1. [14.3.1 Helm](#1431-helm)
         2. [14.3.1.1 C-z and Tab switch](#14311-c-z-and-tab-switch)
         3. [14.3.1.2 Helm focus](#14312-helm-focus)
         4. [14.3.1.3 Helm transient state](#14313-helm-transient-state)
      4. [14.4 Discovering](#144-discovering)
         1. [14.4.1 Key bindings](#1441-key-bindings)
            1. [14.4.1.1 Which-key](#14411-which-key)
            2. [14.4.1.2 Helm describe key bindings](#14412-helm-describe-key-bindings)
         2. [14.4.2 Getting help](#1442-getting-help)
         3. [14.4.3 Available layers](#1443-available-layers)
            1. [14.4.3.1 Available packages in Spacemacs](#14431-available-packages-in-spacemacs)
            2. [14.4.3.2 New packages from ELPA repositories](#14432-new-packages-from-elpa-repositories)
         4. [14.4.4 Toggles](#1444-toggles)
      5. [14.5 Navigating](#145-navigating)
         1. [14.5.1 Point/Cursor](#1451-pointcursor)
            1. [14.5.1.1 Smooth scrolling](#14511-smooth-scrolling)
         2. [14.5.2 Vim motions with avy](#1452-vim-motions-with-avy)
            1. [14.5.2.1 ace-link mode](#14521-ace-link-mode)
         3. [14.5.3 Unimpaired bindings](#1453-unimpaired-bindings)
         4. [14.5.4 Jumping, Joining and Splitting](#1454-jumping-joining-and-splitting)
            1. [14.5.4.1 Jumping](#14541-jumping)
            2. [14.5.4.2 Joining and splitting](#14542-joining-and-splitting)
         5. [14.5.5 Window manipulation](#1455-window-manipulation)
            1. [14.5.5.1 Window manipulation key bindings](#14551-window-manipulation-key-bindings)
            2. [14.5.5.2 Window manipulation transient state](#14552-window-manipulation-transient-state)
            3. [14.5.5.3 Golden ratio](#14553-golden-ratio)
         6. [14.5.6 Buffers and Files](#1456-buffers-and-files)
            1. [14.5.6.1 Buffers manipulation key bindings](#14561-buffers-manipulation-key-bindings)
            2. [14.5.6.2 Buffers manipulation transient state](#14562-buffers-manipulation-transient-state)
            3. [14.5.6.3 Special Buffers](#14563-special-buffers)
            4. [14.5.6.4 Files manipulations key bindings](#14564-files-manipulations-key-bindings)
            5. [14.5.6.5 Emacs and Spacemacs files](#14565-emacs-and-spacemacs-files)
            6. [14.5.6.6 Browsing files with Helm](#14566-browsing-files-with-helm)
         7. [14.5.7 Ido](#1457-ido)
         8. [14.5.8 Ido transient state](#1458-ido-transient-state)
         9. [14.5.9 NeoTree file tree](#1459-neotree-file-tree)
            1. [14.5.9.1 NeoTree navigation](#14591-neotree-navigation)
            2. [14.5.9.2 Opening files with NeoTree](#14592-opening-files-with-neotree)
            3. [l or # RET	|open file in window number](#l-or--retopen-file-in-window-number)
            4. [14.5.9.3 Other NeoTree key bindings](#14593-other-neotree-key-bindings)
            5. [14.5.9.4 NeoTree mode-line](#14594-neotree-mode-line)
            6. [14.5.9.5 NeoTree Source Control Integration](#14595-neotree-source-control-integration)
            7. [14.5.9.6 NeoTree Theme](#14596-neotree-theme)
         10. [14.5.10 Bookmarks](#14510-bookmarks)
         11. [14.5.11 DocView mode](#14511-docview-mode)
      6. [14.6 Auto-saving](#146-auto-saving)
         1. [14.6.1 Frequency of auto-saving](#1461-frequency-of-auto-saving)
         2. [14.6.2 Location of auto-saved files](#1462-location-of-auto-saved-files)
         3. [14.6.3 Disable auto-save](#1463-disable-auto-save)
      7. [14.7 Searching](#147-searching)
         1. [14.7.1 With an external tool](#1471-with-an-external-tool)
            1. [14.7.1.1 Useful key bindings](#14711-useful-key-bindings)
            2. [14.7.1.2 Searching in current file](#14712-searching-in-current-file)
            3. [14.7.1.3 Searching in all open buffers visiting files](#14713-searching-in-all-open-buffers-visiting-files)
            4. [14.7.1.4 Searching in files in an arbitrary directory](#14714-searching-in-files-in-an-arbitrary-directory)
            5. [14.7.1.5 Searching in a project](#14715-searching-in-a-project)
            6. [14.7.1.6 Searching the web](#14716-searching-the-web)
         2. [14.7.2 Persistent highlighting](#1472-persistent-highlighting)
         3. [14.7.3 Highlight current symbol](#1473-highlight-current-symbol)
         4. [14.7.4 Visual Star](#1474-visual-star)
         5. [14.7.5按语义列出符号](#1475按语义列出符号)
         6. [14.7.6 Helm-swoop](#1476-helm-swoop)
      8. [14.8编辑](#148编辑)
         1. [14.8.1粘贴文本](#1481粘贴文本)
            1. [14.8.1.1粘贴瞬态](#14811粘贴瞬态)
            2. [14.8.1.2自动缩进粘贴文本](#14812自动缩进粘贴文本)
         2. [14.8.2文本操作命令](#1482文本操作命令)
         3. [14.8.3文本插入命令](#1483文本插入命令)
         4. [14.8.4 Smartparens Strict mode](#1484-smartparens-strict-mode)
         5. [14.8.5 缩放(Zooming)](#1485-缩放zooming)
            1. [14.8.5.1 文本](#14851-文本)
            2. [14.8.5.2 框架(Frame)](#14852-框架frame)
         6. [14.8.6增加/减少数字](#1486增加减少数字)
         7. [14.8.7 拼写检查](#1487-拼写检查)
         8. [14.8.8区域选择](#1488区域选择)
            1. [14.8.8.1 扩大区域(Expand-region)](#14881-扩大区域expand-region)
            2. [14.8.8.2缩进文本对象(Indent text object)](#14882缩进文本对象indent-text-object)
         9. [14.8.9 区域缩小(Region narrowing)](#1489-区域缩小region-narrowing)
         10. [14.8.10 用iedit替换文本(Replacing text with iedit)](#14810-用iedit替换文本replacing-text-with-iedit)
            1. [14.8.10.1 iedit states 键绑定( iedit states key bindings)](#148101-iedit-states-键绑定-iedit-states-key-bindings)
            2. [prefix all occurrences with an increasing number (SPC u to choose the starting number).](#prefix-all-occurrences-with-an-increasing-number-spc-u-to-choose-the-starting-number)
            3. [14.8.10.2 例子](#148102-例子)
         11. [14.8.11 替换几个文件中的文本](#14811-替换几个文件中的文本)
         12. [14.8.12 重命名目录中的文件](#14812-重命名目录中的文件)
         13. [14.8.13 评论](#14813-评论)
         14. [14.8.14 正则表达式](#14814-正则表达式)
         15. [14.8.15 删除文件](#14815-删除文件)
         16. [14.8.16 编辑 lisp 代码](#14816-编辑-lisp-代码)
         17. [14.8.16.1 lisp 键绑定](#148161-lisp-键绑定)
         18. [14.8.17 鼠标使用情况](#14817-鼠标使用情况)
      9. [14.9管理项目](#149管理项目)
      10. [14.10 寄存器(Registers)](#1410-寄存器registers)
      11. [14.11错误处理](#1411错误处理)
      12. [14.12 编译](#1412-编译)
      13. [14.13 模式(Modes)](#1413-模式modes)
         1. [4.13.1 主模式 leader 键(Major Mode leader key)](#4131-主模式-leader-键major-mode-leader-key)
         2. [14.13.2 Helm](#14132-helm)
      14. [14.14 emacs服务器](#1414-emacs服务器)
         1. [14.14.1 连接到 emacs 服务器](#14141-连接到-emacs-服务器)
      15. [14.15 保持服务器开着](#1415-保持服务器开着)
      16. [14.16 故障排除(Troubleshoot)](#1416-故障排除troubleshoot)
         1. [14.16.1 Loading fails](#14161-loading-fails)
         2. [14.16.2 升级/降级 Emacs 版本](#14162-升级降级-emacs-版本)
